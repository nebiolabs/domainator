...
from domainator.Bio.Data.CodonTable import standard_dna_table
from domainator.Bio.Seq import complement
from domainator.Bio.Seq import complement_rna
from domainator.Bio.Seq import Seq
from domainator.Bio.Seq import translate
...
def six_frame_translations(seq, genetic_code=1):
    ...
    from domainator.Bio.Seq import reverse_complement_rna
