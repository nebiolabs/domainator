...
|  hmmer_report.py |  Writes a tabular report from .hmm files, with a line for each profile | one or more .hmm files | a tab separated, html, or JSON (`--json`, streaming NDJSON) metadata table | yes  | yes  |  |
